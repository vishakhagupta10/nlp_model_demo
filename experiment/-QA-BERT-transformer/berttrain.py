from bertcore import convert_data_to_feature, make_dataset, split_dataset, compute_accuracy, use_model
...
if __name__ == "__main__":
    ...
    model_setting = {
        "model_name":"bert",
        "config_file_path":"bert-base-uncased",
        "model_file_path":"bert-base-uncased",
    ...
    #
    data_feature = convert_data_to_feature(tokenizer,'myASQ.json')
    ...
    for epoch in range(40):
        ...
        for batch_index, batch_dict in enumerate(train_dataloader):
            ...
            # log
            print("epoch:%2d batch:%4d run_train_loss:%2.4f run_train_acc:%3.4f"%(epoch+1, batch_index+1, running_loss_val, running_acc))
            print("epoch:%2d batch:%4d train_loss:%2.4f train_acc:%3.4f"%(epoch+1, batch_index+1, loss_t, acc_t))
        running_loss_val = 0.0
        running_acc = 0.0
