from ASQfaccore import convert_data_to_feature, make_dataset, split_dataset, compute_accuracy, use_model
...
if __name__ == "__main__":
    ...
    model_setting = {
        "model_name":"bert",
        "config_file_path":"emilyalsentzer/Bio_ClinicalBERT",
        "model_file_path":"emilyalsentzer/Bio_ClinicalBERT",
        "vocab_file_path":"emilyalsentzer/Bio_ClinicalBERT",
        "num_labels":149  # 分幾類
    }
    ...
    #
    data_feature = convert_data_to_feature(tokenizer,'BioASQ-trainingDataset4b.json')
